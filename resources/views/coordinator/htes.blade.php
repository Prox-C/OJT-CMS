              ...
              <table class="table table-bordered text-nowrap mb-0">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td class="align-middle text-center text-medium">
                              0 /{{ $hte->slots }}
                          </td>
                          <td class="text-center">
                              ...
                              @else
                                  ...
                                  @elseif($hte->status == 'new')
                                      <span class="badge badge-sm bg-danger-subtle text-danger px-3 py-2 rounded-4 w-100">Missing</span>
                                  @endif
                              @endif
                          </td>
                          <td class="text-center px-2 align-middle" style="white-space: nowrap;">
                              <button class="btn btn-primary btn-sm view-hte" data-hte-id="{{ $hte->id }}">
                              ...
                              <button class="btn btn-danger btn-sm remove-hte" data-hte-id="{{ $hte->id }}">
