        ...
        <div class="container-fluid">
          <div class="card">
              ...
              <div class="d-flex flex-grow-1 justify-content-end p-0">
                  ...
                  <a href="{{ route('coordinator.new_h') }}" class="btn btn-primary btn-sm d-flex">
                      <span>Register</span>
                  </a>
              </div>
              </div>      
              ...
              <table class="table table-bordered text-nowrap mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>HTE001</td>
                      <td>LGU of Carigara</td>
                      <td>juan.delacruz@carley.org</td>
                      <td>Government</td>
                      <td class="align-middle text-center text-medium">22/25</td>
                      <td class="text-center"><span class="badge badge-sm bg-dark-subtle text-dark px-3 py-2 rounded-4 w-100">Active</span></td>
                      <td class="text-center px-2 align-middle" style="white-space: nowrap;">
                        <a href="#" class="btn btn-primary btn-sm">
                            <span class="d-none d-sm-inline">View</span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="table-action-icon" viewBox="0 0 256 256"><path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208ZM90.34,165.66a8,8,0,0,1,0-11.32L140.69,104H112a8,8,0,0,1,0-16h48a8,8,0,0,1,8,8v48a8,8,0,0,1-16,0V115.31l-50.34,50.35a8,8,0,0,1-11.32,0Z"></path></svg>                              
                        </a>
                    ...
                    <tr>
                      <td>HTE002</td>
                      <td>Prox-C Tech Solutions</td>
                      <td>michael.reeves@proxc.org</td>
                      <td>Technology</td>
                      <td class="align-middle text-center text-medium">31/40</td>
                      <td class="text-center"><span class="badge badge-sm bg-primary-subtle text-primary px-3 py-2 rounded-4 w-100">New</span></td>
                      <td class="text-center px-2 align-middle" style="white-space: nowrap;">
                        <a href="#" class="btn btn-primary btn-sm">
                            <span class="d-none d-sm-inline">View</span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="table-action-icon" viewBox="0 0 256 256"><path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208ZM90.34,165.66a8,8,0,0,1,0-11.32L140.69,104H112a8,8,0,0,1,0-16h48a8,8,0,0,1,8,8v48a8,8,0,0,1-16,0V115.31l-50.34,50.35a8,8,0,0,1-11.32,0Z"></path></svg>                              
